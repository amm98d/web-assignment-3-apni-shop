    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 10, 3, "mango.jpg", 5, null, "Mango" },
                    { 2, true, 1, 0, "perfume.jpg", 4, null, "Perfume" },
                    { 3, true, 5, 10, "airpods.jpg", 4, null, "Airpods" },
                    { 4, true, 2, 1, "controller.jpg", 3, null, "Controller" },
                    { 5, true, 25, 50, "burger.jpg", 5, null, "Burger" },
                    { 6, true, 15, 8, "shirt.jpg", 4, null, "Shirt" },
                    { 7, true, 0, 0, "shoes.jpg", 1, null, "Shoes" },
                    { 8, true, 5, 1, "watch.jpg", 2, null, "Watch" }
                });
